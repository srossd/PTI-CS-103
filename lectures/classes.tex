...
For example, you can think of \ic{java.util.ArrayList} as refering to a file \ic{ArrayList.java} in the \ic{util} subdirectory of the \ic{java} root directory. As a programmer, you can write your own packages for others to use. In this course, you won't learn to do that, but you should know that packages exist and that we use code from others by importing packages.
